...
$contactEmail = 'contact@vazatech.store';
$brand = 'VAZATECH';
...
<head>
  ...
  <style>
    :root{
      --bg:#0b0614; --panel:#0d0a1a; --card:#121127;
  ...
  border-radius:10px; background:#0f132b; /* biar kontras di tema gelap */
  padding:6px; box-shadow:0 8px 20px rgba(26,115,232,.35);
}
    ...
    p, li{line-height:1.7; color:#dfe6ff}
    ...
    .btn{display:inline-flex; align-items:center; gap:8px; padding:10px 14px; border-radius:12px; text-decoration:none; font-weight:800;
      background:#1733ff; color:#fff; border:1px solid transparent; box-shadow:0 10px 22px rgba(46,107,255,.25)}
    .btn:hover{filter:brightness(1.07); transform:translateY(-1px)}
    hr{border:0; height:1px; background:var(--line); margin:18px 0}
    @media print{
      body{background:#fff; color:#000}
      .card,.note{border:1px solid #ccc}
